...
package net.mcreator.scaryblockmod.block;
...
public class ScaryBlockBlock extends ScaryblockmodModElements.ModElement {
	@ObjectHolder("scaryblockmod:scary_block")
	public static final Block block = null;

	public ScaryBlockBlock(ScaryblockmodModElements instance) {
		super(instance, 1);
	}
